/** @file
 *	@brief MAVLink comm protocol generated from 401.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef MAVLINK_401_H
#define MAVLINK_401_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_401.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
