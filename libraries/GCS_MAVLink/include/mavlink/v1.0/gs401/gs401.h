/** @file
 *	@brief MAVLink comm protocol generated from gs401.xml
 *	@see http://qgroundcontrol.org/mavlink/
 */
#ifndef MAVLINK_GS401_H
#define MAVLINK_GS401_H

#ifndef MAVLINK_H
    #error Wrong include order: MAVLINK_GS401.H MUST NOT BE DIRECTLY USED. Include mavlink.h from the same directory instead or set ALL AND EVERY defines from MAVLINK.H manually accordingly, including the #define MAVLINK_H call.
#endif
